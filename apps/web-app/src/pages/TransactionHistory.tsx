...
export default function TransactionHistoryPage() {
	...
	return (
		<div className="w-full min-h-200 bg-[#f4f4f5] dark:bg-[#090C1A] py-8 px-6 flex justify-center text-gray-900 dark:text-white transition-colors">
			<div className="w-full max-w-4xl">
				...
				<h2 className="md:text-xl text-lg font-semibold mb-4 text-gray-900 dark:text-white">
					Transaction History
				</h2>
					...
					<div className="flex items-center space-x-2 mt-4 md:mt-0">
						{tabs.map((tab) => (
							<button
								...
								className={`px-4 py-1.5 rounded-md md:text-sm text-xs transition-colors cursor-pointer ${
									selectedTab === tab
				...
				<div className="overflow-x-auto scrollbar-hide">
					<div className="space-y-4 min-w-125">
						{/* Header */}
						<div className="flex justify-between text-xs font-medium text-gray-500 dark:text-gray-400 py-4 border-b border-gray-400/25 dark:border-white/10 uppercase tracking-wide">
						...
						{filteredTransactions.map((txn: any) => {
							...
							return (
								<div
									key={txn.id}
									className="py-3.5 border-b border-gray-400/25 dark:border-white/10 hover:bg-black/2 dark:hover:bg-white/2 transition-colors px-2"
								>
