...
export default function Settings() {
	...
	return (
		<div className="w-full min-h-screen bg-[#f4f4f5] dark:bg-[#090C1A] flex justify-center py-4 md:py-8 transition-colors">
			<div className="w-full max-w-236 px-6 flex flex-col gap-6">
				<nav className="md:text-base text-sm mt-4 mb-6">
					...
					<div className="flex-1 max-w-3xl">
						{activeTab === 'profile' && (
							<div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
								...
								<div>
									...
									<div className="bg-white dark:bg-[#111827] border border-gray-200 dark:border-white/5 rounded-2xl p-4 shadow-sm focus-within:border-gray-400 dark:focus-within:border-white/20 transition-colors">
										<textarea
											value={bio}
						...
						{activeTab === 'account' && (
							<div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
								...
								<div className="bg-white dark:bg-[#111827] border border-gray-200 dark:border-white/5 rounded-2xl p-6 shadow-sm">
